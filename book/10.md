...
- `sqlite-dll-win64-x64-xxxxxx.zip` (64비트용) 또는  
  `sqlite-dll-win32-x86-xxxxxx.zip` (32비트용)
...
- `sqlite3.dll`  
   ...
   (예: `C:\Users\...\source\repos\MyProject\MyProject\`)
